const SnowTable = {
    snow_alpha_mul: new Uint32Array([
    ...
    snow_alphainv_mul: new Uint32Array([
...
class SnowCipher {
     ...
     */
    constructor(keySize, key, ivTable) {
		this.#statusTable = {
            ctr:0,
        ...
        if (keySize == 128) {
            this.#statusTable.st[15] = U8TO32_BE(key, 0)
            this.#statusTable.st[14] = U8TO32_BE(key, 4)
            this.#statusTable.st[13] = U8TO32_BE(key, 8)
            this.#statusTable.st[12] = U8TO32_BE(key, 12)
            ...
            this.#statusTable.st[13] = U8TO32_BE(key, 8)
            this.#statusTable.st[12] = U8TO32_BE(key, 12)
            this.#statusTable.st[11] = U8TO32_BE(key, 16)
            this.#statusTable.st[10] = U8TO32_BE(key, 20)
            this.#statusTable.st[9] =  U8TO32_BE(key, 24)
            this.#statusTable.st[8] =  U8TO32_BE(key, 28)
        ...
        //XOR IV VALUES
        this.#statusTable.st[15] = (this.#statusTable.st[15] ^ ivTable[3])>>>0;
        this.#statusTable.st[12] = (this.#statusTable.st[12] ^ ivTable[2])>>>0;
        this.#statusTable.st[10] = (this.#statusTable.st[10] ^ ivTable[1])>>>0;
        this.#statusTable.st[9]  = (this.#statusTable.st[9]  ^ ivTable[0])>>>0;
